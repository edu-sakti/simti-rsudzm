...
<div class="container-fluid p-0">
    <h1 class="h3 mb-3">Tambah Profil</h1>
            ...
            <form method="POST" action="{{ route('pegawai.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="provinsi" id="provinsi" class="form-select @error('provinsi') is-invalid @enderror" data-selected="{{ old('provinsi') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kabupaten" id="kabupaten" class="form-select @error('kabupaten') is-invalid @enderror" data-selected="{{ old('kabupaten') }}" disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="kecamatan" id="kecamatan" class="form-select @error('kecamatan') is-invalid @enderror" data-selected="{{ old('kecamatan') }}" disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="desa" id="desa" class="form-select @error('desa') is-invalid @enderror" data-selected="{{ old('desa') }}" disabled>
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <a href="{{ url('/apps') }}" class="btn btn-outline-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
